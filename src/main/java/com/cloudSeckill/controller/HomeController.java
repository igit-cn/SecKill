...
//    private WechatServiceInter wechatService;
    ...
    public @ResponseBody
    ResponseBean getCurrentOnlineUserNumber() {
    ...
    public @ResponseBody
    ResponseBean queryRechargeCodeStatus(@RequestBody QueryRechargeCodeRequest queryRechargeCodeRequest, HttpSession session) {
...
//            }
    ...
    public @ResponseBody
    ResponseBean removeItem(@RequestBody RemoveItemRequest request) {
    ...
    public @ResponseBody
    ResponseBean rechargeCodeUp(@RequestBody RechargeRequest rechargeCode, HttpSession session) {
