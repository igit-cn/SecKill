...
public class ReceiveDataController extends BaseController {
    ...
    @Autowired private WechatService wechatServeice;
    ...
    public @ResponseBody ResponseBean notification(String type,String WXUserId) {
    ...
    private void MsgSync(String token) {
        ...
        httpClient.addParams("method", "WXSyncMessage");
        httpClient.addParams("object", token);
        httpClient.send(new HttpCallBack<List<DataInfoBean>>() {
            @Override
    ...
    private void sendTextMsg(User user,String msg,String chatRoom,boolean isSaveDB){
        ...
        HttpClient httpClient = new HttpClient();
        httpClient.setUrl("http://" + redisUtil.getStr("keng_id-" + user.getId()) + ":12888/api.php");
        httpClient.addParams("method", "WXSendMsg");
    ...
    private void ReceiveRedPacket(String json, String token, String chatRoom,boolean isGroup) {
        ...
        HttpClient httpClient = new HttpClient();
        httpClient.setUrl("http://" + redisUtil.getStr("keng_id-" + user.getId()) + ":12888/api.php");
        httpClient.addParams("method", "WXReceiveRedPacket");
        httpClient.addParams("object", token);
    ...
    private void redPick(String json, String token, String key, String chatRoom, boolean isGroup) {
        ...
        HttpClient httpClient = new HttpClient();
        httpClient.setUrl("http://" + redisUtil.getStr("keng_id-" + user.getId()) + ":12888/api.php");
        httpClient.addParams("method", "WXOpenRedPacket");
        httpClient.addParams("object", token);
        httpClient.addParams("red_packet", json);
    ...
    private void pickTransfer(String json, String token){
        ...
        HttpClient httpClient = new HttpClient();
        httpClient.setUrl("http://" + redisUtil.getStr("keng_id-" + user.getId()) + ":12888/api.php");
        httpClient.addParams("method", "WXTransferOperation");
        httpClient.addParams("object", token);
